...
public abstract class DAO {
    ...
    protected void conectarBase() throws ClassNotFoundException, SQLException {
        try {
            ...
            + "?zeroDateTimeBehavior=convertToNull [root on Default schema]";  //"?useSSL=false";
    ...
    protected void desconectarBase() throws SQLException{  //Exception {
        try {
            if (resultado != null) {
                resultado.close();
            }
    ...
    protected void consultarBase(String sql) throws ClassNotFoundException, SQLException {  //Exception {
        try {
            conectarBase();
            sentencia = conexion.createStatement();
